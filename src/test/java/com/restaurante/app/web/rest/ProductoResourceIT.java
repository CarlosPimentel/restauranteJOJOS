...
class ProductoResourceIT {
    ...
    private static final Integer DEFAULT_TIPO = 0;
    private static final Integer UPDATED_TIPO = 1;
    ...
    void createProducto() throws Exception {
        ...
        assertThat(testProducto.getUrl()).isEqualTo(DEFAULT_URL);
    }
    ...
    void putNewProducto() throws Exception {
        ...
        assertThat(testProducto.getUrl()).isEqualTo(UPDATED_URL);
    }
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.tipo(UPDATED_TIPO).referencia(UPDATED_REFERENCIA).iva(UPDATED_IVA);
